...
function trocarAvatar() {
    // Solicita ao usuário para inserir o novo caminho da imagem
    ...
    // Verifica se um novo caminho foi fornecido
    if (novoCaminho !== null) {
        // Atualiza o src da imagem para o novo caminho fornecido
